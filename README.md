...
* **Usability:** Configurable media keys support, swipe/scroll gesture recognition, Control Center integration (remote control)
...
| :---:        | :-:             | :-:       |
| macOS 10.12 - 10.15 | [1.0.0](https://github.com/maculateConception/aural-player/releases/tag/v1.0.0)           | [3.0.0](https://github.com/maculateConception/aural-player/releases/tag/3.0.0)     |
