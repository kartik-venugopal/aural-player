...
Aural Player uses [FFmpeg](https://www.ffmpeg.org/) which, in the binary form used by Aural Player, is licensed under GPL v3. In compliance with the license, I have made the FFmpeg source code (and instructions to compile it) available as an archive in the source code under [/Resources/ffmpeg](https://github.com/maculateConception/aural-player/tree/master/Resources/ffmpeg), and also as an asset with each release of Aural Player.
