...
### Usability
Command Aural in many ways - Handy keyboard shortcuts for common tasks, configurable media keys, swipe/scroll gestures, Control Center integration ("remote control").
