//
//  SequencerPeeking_GroupingPlaylists_Tests.swift
//  Aural
//
...
class SequencerPeeking_GroupingPlaylists_Tests: SequencerTests {
    
    var scopeTracks: [Track] = []
    var scopeSize: Int {return scopeTracks.count}
    
    private func playlistUpdated(_ playlistType: PlaylistType) {
