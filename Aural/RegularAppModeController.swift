...
class RegularAppModeController: AppModeController, ActionMessageSubscriber {
    ...
    func toggleEffects() {
        ...
        resizeMainWindow(WindowState.showingEffects)
    ...
    private func resizeMainWindow(_ effectsShown: Bool) {
