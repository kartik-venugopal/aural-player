...
class TextSizes {
    ...
    private static let feedbackFont_normal: NSFont = NSFont(name: "Gill Sans Semibold", size: 11)!
    private static let feedbackFont_larger: NSFont = NSFont(name: "Gill Sans Semibold", size: 12)!
    private static let feedbackFont_largest: NSFont = NSFont(name: "Gill Sans Semibold", size: 13)!
