...
//        
//        print("MainWindow positioned at:", mainWindow.x, mainWindow.y)
//        print("Playlist positioned at:", playlistWindow.frame.origin.x, playlistWindow.y)
//    }
//    
...
//        
//        print("Playlist at:", playlistWindow.x, playlistWindow.y)
//        
//        // Update the flag to indicate that an automated move/resize operation is no longer taking place
//        automatedPlaylistMoveOrResize = false
//    }
...
//        
//        let playlistX = mainWindow.x
//        let playlistY = mainWindow.y - playlistHeight
//        playlistFrame.origin = NSPoint(x: playlistX, y: playlistY)
//        
//        print("Repos X", playlistX)
//        
