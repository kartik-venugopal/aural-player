...
--disable-demuxers \
--enable-demuxer=aac,ape,asf,dsf,flac,mp3,mpc,mpc8,wv,dts,dtshd,tta,tak \
--enable-demuxer=ogg,matroska,rm \
--enable-demuxer=mjpeg,mjpeg_2000,mpjpeg \
--disable-decoders \
--enable-decoder=aac,ape,flac,mp1,mp1_at,mp1float,mp2,mp2_at,mp2float,mpc7,mpc8,dsd_lsbf,dsd_lsbf_planar,dsd_msbf,dsd_msbf_planar,opus,cook,ra_144,ra_288,ralf,sipr,tta,tak,vorbis,wavpack,wmav1,wmav2,wmalossless,wmapro,wmavoice,dca \
--enable-decoder=bmp,png,jpeg2000,jpegls,mjpeg,mjpegb \
--disable-parsers \
--enable-parser=aac,flac,mpegaudio,opus,vorbis,dca,ac3,tak,cook,sipr \
