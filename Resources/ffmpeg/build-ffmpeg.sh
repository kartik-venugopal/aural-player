...
function configureAndMake {
    ...
    ./configure \
    --cc=/usr/bin/clang \
    --extra-ldflags="-mmacosx-version-min=${minMacOSVersion} -isysroot ${sdk}" \
    --extra-cflags="-mmacosx-version-min=${minMacOSVersion} -isysroot ${sdk}" \
    --extra-libs=-lpthread \
