...
# Usage:
#
# ./build-bundle.sh          (No argument specified, will build DMG)
# ./build-bundle.sh app      (Will build app bundle only)
# ./build-bundle.sh dmg      (Will build DMG suitable for release, i.e. containing app bundle, release notes, and license)
#
