...
/*
    A custom AVAudioPlayerNode that provides convenient scheduling functions that convert seek times to audio frame positions.
    Callers can schedule segments in terms of seek times and do not need to compute segments in terms of audio frames.
 */
