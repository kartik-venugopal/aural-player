// NOTE - This is experimental code not currently in use. It is not ready for use in production.
...
// */
//@available(OSX 10.13, *)
//class GaplessScheduler: PlaybackSchedulerProtocol {
//
...
//        stop()
//
//        _ = scheduleSegment(session, .dataConsumed, {(callbackType: AVAudioPlayerNodeCompletionCallbackType) -> Void in
//
//            DispatchQueue.global(qos: .userInteractive).async {
//
//                let tim = TimerUtils.start("pre-fetch")
//                let completionBuffer = AudioIO.createSilentBuffer(session.track.playbackInfo!.audioFile!)
//                self.playerNode.scheduleBuffer(completionBuffer, completionCallbackType: .dataPlayedBack, completionHandler: {(callbackType:
//
...
//
//                tim.end()
//                NSLog("Done scheduling last buffer: " + String(describing: tim.durationMsecs))
//            }
//
//        }, true, startTime)
//
...
//        if beginPlayback {
//            playerNode.play()
//            NSLog("Started playing: " + String(describing: session.track.duration))
//        }
//    }
//
