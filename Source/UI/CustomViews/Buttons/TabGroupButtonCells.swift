...
class PlaylistViewsButtonCell: TabGroupButtonCell {
    ...
    override var textFont: NSFont {return FontSets.systemFontSet.playlist.tabButtonTextFont}
    override var boldTextFont: NSFont {return FontSets.systemFontSet.playlist.tabButtonTextFont}
...
class EQSelectorButtonCell: TabGroupButtonCell {
    ...
    override var boldTextFont: NSFont {return FontSets.systemFontSet.effects.unitFunctionFont}
