...
class PlaybackPreferencesViewController: NSViewController, PreferencesViewProtocol {
    ...
    private let generalPreferencesView: PreferencesViewProtocol = GeneralPlaybackPreferencesViewController()
    private let autoplayPreferencesView: PreferencesViewProtocol = AutoplayPreferencesViewController()
