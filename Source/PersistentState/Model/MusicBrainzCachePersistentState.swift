...
class MusicBrainzCachePersistentState: PersistentStateProtocol {
    ...
    required init?(_ map: NSDictionary) {
        ...
        self.releases = map.arrayValue(forKey: "releases", ofType: MusicBrainzCacheEntryPersistentState.self)
        self.recordings = map.arrayValue(forKey: "recordings", ofType: MusicBrainzCacheEntryPersistentState.self)
    }
}
